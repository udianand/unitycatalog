...
def execute_tool_calls(
    ...
    for tool_call in tool_calls:
        result = client.execute_function(tool_call['function_name'], tool_call['parameters'])
        results.append({
...
def generate_tool_call_session_state(tool_result: Dict[str, Any], tool_call: Dict[str, Any]) -> Dict[str, Any]:
